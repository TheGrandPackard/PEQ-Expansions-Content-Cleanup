...
-- Dulia Jestes
UPDATE merchantlist SET min_expansion=70 WHERE merchantid=383172 AND item IN(36293, 90327, 90318, 36288, 36296, 36290, 36399, 90319, 90321, 64914, 64912, 36295, 36289, 36291, 36297, 36294, 90317, 64910, 36298, 90320, 64913, 36292, 64911); 
-- Gurb Smithson
